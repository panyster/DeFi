...
#[derive(Debug)]
pub struct DeFiCogniProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DeFiCogniProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DeFiCogni processing");
    
    let mut processor = DeFiCogniProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DeFiCogniProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DeFiCogniProcessor::new(false);
